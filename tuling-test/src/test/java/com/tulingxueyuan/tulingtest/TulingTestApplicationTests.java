...
class TulingTestApplicationTests {
    ...
    void uploadOSS() throws FileNotFoundException {
        ...
        // 3. 给子用户设置权限
        String accessKeyId = "LTAI5tMaGgXBDVavtNrN8UiV";
        String accessKeySecret = "VzleSrBkGdggL5neQr0T3xsBS9LxtV";
        ...
        // 上传文件流。
        InputStream inputStream = new FileInputStream("C:\\Users\\20143\\Pictures\\Camera Roll\\动漫\\1204bd3417eac454909d283631d6b483.jpg");
        ossClient.putObject("jiucontinent", dir+"1204bd3417eac454909d283631d6b483.jpg", inputStream);
